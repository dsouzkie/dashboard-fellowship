...
const loginFix = `function login(username, pwd) {
...
// Re-extract from the original backup!
code = fs.readFileSync('test_login.js', 'utf8');
...
code = code.replace(oldLogin, loginFix);
